...
class MIDRAN:
    def __init__(self, config):
        ...
        # Optimizers
        self.optimizerEG = torch.optim.Adam(self.net.parameters(), lr=self.learningRate,
    ...
    def customTrainLoader(self, overFitTest=False):
        ...
        datasetReadder = customDatasetReader(dataset_name=self.dataset_name,
                                             mode='train',
                                             height=self.imageH,
                                             width=self.imageW,
                                             )
        if overFitTest == True:
            datasetReadder = datasetReadder[-1:]
    ...
    def modelTraining(self, resumeTraning=False, overFitTest=False, dataSamples=None):
        ...
        if resumeTraning == True:
            ...
            try:
                ...
                # print()
                customPrint(Fore.RED + "Would you like to start training from sketch (default: Y): ",
    ...
    def modelInference(self, testImagesPath=None, outputDir=None, resize=None, validation=None, noiseSet=None,
        ...
        modelInference = inference(inputRootDir=self.testImagesPath, outputRootDir=self.resultDir,
    ...
    def savingWeights(self, currentStep, duplicate=None):
        ...
        if duplicate:
            saveCheckpoint(modelStates=checkpoint, path=self.checkpointPath + str(currentStep) + "/",
